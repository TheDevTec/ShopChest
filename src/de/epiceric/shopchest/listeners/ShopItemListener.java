...
public class ShopItemListener implements Listener {
    ...
    public void onPlayerLeave(PlayerQuitEvent e) {
        for (Shop shop : plugin.getShopUtils().getShops()) {
            ...
            if (shop.getNoItem() != null) {
                shop.getNoItem().setVisible(e.getPlayer(), false);
            }
        }
    }
    ...
    public void onBlockPlace(BlockPlaceEvent e) {
        ...
        if (shopUtils.isShop(below.getLocation())) {
            ...
            if (Utils.getAmount(shop.getInventoryHolder().getInventory(), shop.getProduct()) < shop.getProduct().getAmount() && shop.getBuyPrice() != 0 && (shop.getShopType() == Shop.ShopType.NORMAL)) {
                if (shop.getNoItem() != null) {
                    shop.getNoItem().resetForPlayer(e.getPlayer());
                }
            }
            e.setCancelled(true);
        }
    ...
    public void onMultiBlockPlace(BlockMultiPlaceEvent e) {
        for (BlockState blockState : e.getReplacedBlockStates()) {
            ...
            if (shopUtils.isShop(below.getLocation())) {
                ...
                if (Utils.getAmount(shop.getInventoryHolder().getInventory(), shop.getProduct()) < 1 && shop.getBuyPrice() != 0) {
                    if (shop.getNoItem() != null) {
                        shop.getNoItem().resetForPlayer(e.getPlayer());
                    }
                }
        ...
        for (Block b : e.getBlocks()) {
            ...
            if (shopUtils.isShop(belowNewBlock.getLocation())) {
                ...
                for (Player p : Bukkit.getOnlinePlayers()) {
                    ...
                    if (Utils.getAmount(shop.getInventoryHolder().getInventory(), shop.getProduct()) < shop.getProduct().getAmount() && shop.getBuyPrice() != 0) {
                        if (shop.getNoItem() != null) {
                            shop.getNoItem().resetForPlayer(p);
                        }
                    }
                }
            }
    ...
    public void onBucketEmpty(PlayerBucketEmptyEvent e) {
        ...
        if (shopUtils.isShop(clicked.getLocation())) {
            if (e.getBucket() == Material.LAVA_BUCKET) {
                ...
                int amount = (e.getPlayer().isSneaking() ? shop.getProduct().getMaxStackSize() : shop.getProduct().getAmount());
                if (Utils.getAmount(shop.getInventoryHolder().getInventory(), shop.getProduct()) < amount && shop.getBuyPrice() != 0 ) {
                    if (shop.getNoItem() != null) {
                        shop.getNoItem().resetForPlayer(e.getPlayer());
                    }
                }
